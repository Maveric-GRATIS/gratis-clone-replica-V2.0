...
const formSchema = z.object({
  ...
  flavor_vision: z.string().min(10, 'Please describe your flavor vision').max(500),
  impact_cause: z.string().min(10, 'Please describe your preferred cause').max(500),
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "We're excited to create something unique with you. We'll contact you within 48 hours.",
      });
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
        ...
        <p className="text-xs text-center text-muted-foreground">
          By submitting, you agree to be contacted about your F.U. collaboration.
