    ...
    <>
      <div className="relative overflow-hidden rounded-xl border-2 border-yellow-500/50 bg-gradient-to-r from-yellow-500/10 via-yellow-400/5 to-yellow-500/10 p-6">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -right-4 top-1/4 h-20 w-20 animate-pulse rounded-full bg-yellow-500/10 blur-xl"
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold text-yellow-400">
                  {t("waterPage.goldenTicket.title")}
                </h3>
                <Sparkles className="h-4 w-4 text-yellow-500 animate-pulse" />
              </div>
              <p className="text-sm text-muted-foreground">
                {t("waterPage.goldenTicket.description")}
              </p>
              <div className="flex items-center gap-2 pt-1">
                <Gift className="h-4 w-4 text-yellow-500" />
                <span className="text-xs font-medium text-yellow-400/80">
                  {t("waterPage.goldenTicket.prizes")}
                </span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            {t("waterPage.goldenTicket.claimPrize")}
          </Button>
        </div>
      </div>
