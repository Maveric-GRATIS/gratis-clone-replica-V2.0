...
export default function RigStore() {
  ...
  const allCollections = getMVPCollections();

  return (
    <div className="min-h-screen bg-black">
      <SEO
        title="RIG Store - GRATIS Streetwear"
        description="Bold streetwear. Vibrant energy. Premium quality merchandise from GRATIS."
      />
      ...
      <section className="relative bg-gradient-to-br from-gray-900 to-black py-20 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="text-center mb-12">
            ...
            <p
              className="text-xl text-gray-400 max-w-3xl mx-auto mb-8 animate-fade-in"
              style={{
                animationDelay: "100ms",
                animationFillMode: "backwards",
              }}
            >
              Bold streetwear. Vibrant energy. Premium quality that makes a
              statement.
            </p>
            <div
      ...
      <section className="bg-gray-950 py-20 border-y border-gray-800">
        <div className="container">
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg">
              Discover curated collections that define the GRATIS style
            </p>
          </div>
            ...
            {featuredCollections.map((collection, index) => (
              ...
              >
                <div className="aspect-[4/3] relative overflow-hidden">
                  ...
                  {/* Acrostic Letter */}
                  <div
                    className="absolute top-4 left-4 w-16 h-16 rounded-full flex items-center justify-center font-black text-3xl text-black z-10"
                    style={{ backgroundColor: collection.color }}
                  >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <ArrowRight className="w-5 h-5 text-primary transform group-hover:translate-x-2 transition-transform" />
                    </div>
                  </div>
                </div>
              </Link>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {allCollections
              ...
              .map((collection) => (
                ...
                >
                  <div
                    className="absolute top-2 right-2 w-10 h-10 rounded-full flex items-center justify-center font-black text-lg text-black"
                    style={{ backgroundColor: collection.color }}
                  >
                    {collection.acrosticLetter}
                  </div>
                  <h4 className="text-lg font-bold text-white mb-1 pr-12">
                    {collection.name}
                  </h4>
              ...
              {filteredProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 p-8">
                    ...
                    <div
                      className={`absolute top-4 right-4 flex flex-col gap-2 transform-gpu transition-all duration-300 ease-out ${
      ...
      <section className="bg-gradient-to-r from-yellow-400 via-pink-500 to-cyan-400 py-16">
        <div className="container text-center">
          ...
          <p className="text-black/80 mb-8 max-w-2xl mx-auto">
            Get exclusive drops, vibrant deals, and be the first to know about
            our newest streetwear collections. Stay connected with the boldest
            community in streetwear.
          </p>
