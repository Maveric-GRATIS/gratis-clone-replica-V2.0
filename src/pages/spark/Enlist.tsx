  ...
  const jobs = [
    {
      ...
      category: "volunteer",
      description:
        "Coordinate logistics for festivals, pop-ups, and community events. Manage volunteers, liaise with venues, ensure smooth operations.",
      requirements: [
    ...
    },
    {
      ...
      category: "volunteer",
      description:
        "Lead street distribution teams, manage inventory, track impact metrics, train new volunteers.",
      requirements: [
    ...
    },
    {
      ...
      category: "internship",
      description:
        "Create content, manage social channels, analyze engagement metrics, develop campaigns.",
      requirements: [
    ...
    },
    {
      ...
      category: "internship",
      description:
        "Track donation impact, compile reports, communicate with beneficiaries, maintain impact dashboard.",
      requirements: [
    ...
    },
    {
      ...
      category: "fulltime",
      description:
        "Oversee day-to-day NGO operations, manage supply chain, coordinate distribution networks, optimize processes.",
      requirements: [
        "3+ years operations experience",
        "NGO or logistics background",
    ...
    },
    {
      ...
      category: "fulltime",
      description:
        "Build brand partnerships, negotiate advertising deals, maintain NGO relationships, drive revenue growth.",
      requirements: [
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold mb-4">
                GRATIS BRAND AMBASSADOR
              </h2>
              <Badge
                variant="secondary"
                className="bg-accent/20 text-accent-foreground text-base px-4 py-2"
              >
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2 text-sm">
                      <span className="text-primary">✓</span>
                      <span>
                        Drive local brand partnerships and advertising deals
                      </span>
                    </li>
                    <li className="flex items-start gap-2 text-sm">
                      <span className="text-primary">✓</span>
                      <span>
                        Organize community events and distribution activations
                      </span>
                    </li>
                    <li className="flex items-start gap-2 text-sm">
                      <span className="text-primary">✓</span>
                      <span>
                        Build networks with NGOs, influencers, and local leaders
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="p-4 bg-accent/5 rounded-lg border border-accent/20">
                      ...
                      <div className="text-xs text-muted-foreground">
                        €100-150/month for active ambassadors
                      </div>
                    </div>
                    <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2 text-sm text-muted-foreground">
                      <span className="text-accent">•</span>
                      <span>
                        Strong local presence and network (500+ social following
                        preferred)
                      </span>
                    </li>
                    <li className="flex items-start gap-2 text-sm text-muted-foreground">
                      <span className="text-accent">•</span>
                      <span>
                        Entrepreneurial mindset with sales/partnership
                        experience
                      </span>
                    </li>
                    <li className="flex items-start gap-2 text-sm text-muted-foreground">
                      <span className="text-accent">•</span>
                      <span>
                        Self-motivated, organized, and community-oriented
                      </span>
                    </li>
                  </ul>
                </div>
